...
from shape_generate import setup_runtime, Trainer, Shape_Generate


## runtime arguments
parser = argparse.ArgumentParser(description='Training configurations.')
parser.add_argument('--config', default='configs/fishing.yml', type=str, help='Specify a config file path')
...
print(cfgs)
trainer = Trainer(cfgs, Shape_Generate)
